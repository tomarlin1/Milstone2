<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCoupon.aspx.cs" Inherits="PL.Methods.EditOperations.EditCoupon" %>
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style6">
                    <asp:Label ID="Label4" runat="server" Text="enter coupon id:" Width="250px"></asp:Label>
                </td>
                <td class="auto-style2" colspan="4">
                    <asp:TextBox ID="txtBoxCouponId" runat="server" Width="150px"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Coupon id is required." ForeColor="#FF3300" ControlToValidate="txtBoxCouponId"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                ...
                <td class="auto-style12" colspan="4">
                    <asp:DropDownList ID="DropDownList1" runat="server">
                        ...
                        <asp:ListItem>OriginalPrice</asp:ListItem>
                        <asp:ListItem>DiscountPrice</asp:ListItem>
                        <asp:ListItem>ExpiredDate</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="auto-style6">
                    &nbsp;</td>
                <td class="auto-style2" colspan="4">
                    <asp:Button ID="btnEdit" runat="server" OnClick="addCoupon_btn_Click" style="text-align: left" Text="Edit Coupon" Width="134px" ToolTip="press to add new coupon" />
                </td>
            </tr>
            <tr>
